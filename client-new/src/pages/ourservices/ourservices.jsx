...
const Ourservices = () => {
  ...
  return (
    <>
      <div className="container-xxl  container-xl container-lg container-md service-content pt-md-5 pb-md-5  ">
        <h1>Our Services</h1>
        <h6 className="pt-1">
        ...
        <Slider {...settings}>
          {CityNameImage.map((pos,i) => (
            ...
            <div className="row bg-light rounded-2 service-card me-2 ms-2 " >
              <div className="col p-3 "><img alt={pos.srcImg} src={pos.srcImg} className="  rounded-2 service-card-img"/>
              </div>
             ...
             ><p className="position-absolute bottom-0  pb-3  mb-0 text-muted w-100 View-Detail" > View Detail <HiOutlineArrowNarrowRight className="ms-3 ms-md-1 icon-clr"/></p>
                </Link></div>
            </div>
            </div>
             ))}
        ...
        <div className="row mx-auto add-container  text-center ">
          <div className="col-3">
          <img src="../../clientslogo/celebration.png" className="celebration-logo" alt="celebration"/>
          </div>
          <div className="col-6">
           <span>
